<html>
	<head>
		...
		<meta name="Author" content="DUKTEK"/>
		<meta name="Manager" content=""/>
		<meta name="Company" content="INFOMEDIA"/>

		<title>DETAIL DENAH LANTAI7 CC147 MALANG</title>
		<script src="lt7_files/frameset.js" type="text/jscript" language="jscript"></script>
...
var g_FileList = new  Array(
 new FileEntry (1, 0, "Page-1", "vml_1.htm", "gif_1.htm")
...
function CreateHLObj (hlNode)
{
	...
	<frameset id="frmstOuter" cols="237,*" title="DETAIL DENAH LANTAI2-2011_baru">
		<frame src="lt7_files/toolbar.htm" name="frmToolbar" id="frmToolbar" title="This frame contains tools for manipulating your drawing." frameborder="6" bordercolor="#999999" scrolling="no" marginheight="0" marginwidth="0" >
		<frame src="lt7_files/gif_1.htm" name="frmDrawing" title="This frame contains the pages of your drawing." marginheight="10" marginwidth="10" onload="if (parent.isUpLevel) FramePageLoaded()" >

		<noframes>
			<body>

				<h1>DETAIL DENAH LANTAI1-2011_baru</h1>
				<ul>
				<li><a href="lt7_files/gif_1.htm">Page-1</a></li>
