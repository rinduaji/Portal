...
class ListCCM extends CI_Controller {

	function __construct(){
		parent::__construct();		
		$this->load->model('m_list_ccm');
	...
	public function index()
	{
		...
		$cekJabatan = $this->session->userdata('jabatan');

		$jumlah_data = $this->m_list_ccm->jumlah_data($user_id,$cekJabatan,$data['cari'],$data['date_awal'],$data['date_akhir'], $data['status']);

		$config['base_url'] = base_url('index.php/ListCCM/index');
        ...
        $data['data_list_ccm'] = $this->m_list_ccm->data_list_ccm($user_id,$cekJabatan,$config['per_page'],$data['start'],$data['cari'],$data['date_awal'],$data['date_akhir'], $data['status']);
        // $data['nama_list_ccm_kategori'] = $this->m_list_ccm->nama_list_ccm_kategori();
		$data['cek_verifikasi'] = $this->m_list_ccm->cek_verifikasi($user_id);
		...
		$this->load->view('admin/list_ccm_view',$data);
    ...
    public function ApproveAgent($id) {
		...
		$cekJabatanIdCCM = $this->m_list_ccm->cekJabatanIdCCM($id)->user3;
		$cekId = $this->m_list_ccm->cekJabatanIdCCM($id)->spv;
		// print_r($cekId);
		...
		$data['hasil_jabatan'] = $cekjabatan;
		$data['data_nama_groupmail'] = $this->m_list_ccm->getNamaGroupmail($cekId,$jb_user[0]);
		$data['data_approve_agent'] = $this->m_list_ccm->data_ccm_approve_agent($id);
    ...
    public function ApproveTL($id) {
		...
		$data['hasil_jabatan'] = $cekjabatan;
		$data['data_nama_groupmail'] = $this->m_list_ccm->getNamaGroupmail($cekId,$jb_user[0]);
		$data['data_approve_tl'] = $this->m_list_ccm->data_ccm_approve_tl($id);
    ...
    public function ApproveSpv($id) {
		...
		$data['hasil_jabatan'] = $cekjabatan;
		$data['data_nama_groupmail'] = $this->m_list_ccm->getNamaGroupmail($cekId,$jb_user[0]);
		$data['data_approve_spv'] = $this->m_list_ccm->data_ccm_approve_spv($id);
	...
	public function ApproveManager($id) {
		...
		$data['hasil_jabatan'] = $cekjabatan;
		$data['data_nama_groupmail'] = $this->m_list_ccm->getNamaGroupmail($cekId,$jb_user[0]);
		$data['data_approve_manager'] = $this->m_list_ccm->data_ccm_approve_manager($id);
    ...
    public function Verifikasi($id) {
		...
		$data['hasil_jabatan'] = $cekjabatan;
		$data['data_nama_groupmail'] = $this->m_list_ccm->getNamaGroupmail($cekId,$jb_user[0]);
		$data['data_approve_verifikasi'] = $this->m_list_ccm->data_ccm_approve_verifikasi($id);
	...
	public function updateApproveAgent() {
        ...
        if ($komitmen != "" AND $lup_agn != "") {
			$this->m_list_ccm->updateApprove($id,$data);
			$this->m_list_ccm->updateApproveNotif($id,$data_notif);
			$this->session->set_flashdata('success', 'Data Berhasil diubah');
        }
		else {
			$this->session->set_flashdata('gagal', 'Data Gagal diubah');
		}
		redirect(site_url('ListCCM/index'));
	}
	...
	public function updateApproveManager() {
        ...
        if ($lup_mgr != "") {
			$this->m_list_ccm->updateApproveManager($id,$data);
			// $this->m_list_ccm->updateApproveManagerNotif($id,$data_notif);
			$this->session->set_flashdata('success', 'Data Berhasil diubah');
        }
		else {
			$this->session->set_flashdata('gagal', 'Data Gagal diubah');
	...
	public function edit(){
        ...
        if ($validation->run()) {
			$this->m_list_ccm->update($id,$data);
			$this->session->set_flashdata('success', 'Data Berhasil diubah');
        }
		else {
			$this->session->set_flashdata('gagal', 'Data Gagal diubah');
	...
	public function get_by_id($id) {
		$data = $this->m_list_ccm->get_id($id);
		echo json_encode($data);
	}

	public function hapus() {
		$id= $this->input->post('id');
		if($this->m_list_ccm->delete($id)) {
