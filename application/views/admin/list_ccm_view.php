          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-2 pt-0 pb-2" >
              <nav class="navbar navbar-light bg-light justify-content-between">
                ...
                <form class="form-inline" method="post" action="<?=site_url('ListCCM/index')?>">
                      ...
                      <td class="align-middle text-center">
                        <?php
                          ...
                          if($tanggal_sekarang < $data->tgl_akhir) {
                            if($data->status == 0) {
                              if($hasil_jabatan == "AGENT" || $hasil_jabatan == "INPUTER" || $hasil_jabatan == "SOO" || $hasil_jabatan == "SUPPORT") {
                              ?>
                              <a href="<?=site_url('ListCCM/ApproveAgent/').$data->id?>" class="btn btn-small btn-info" type="button"><i class="fas fa-edit"></i>Komitmen Agent</a>  
                              <?php
                              }
                              else {
                                echo "-";
                            ...
                            elseif($data->status == 1) {
                              ...
                              ?>
                              <a href="<?=site_url('ListCCM/ApproveTL/').$data->id?>" class="btn btn-small btn-info" type="button"><i class="fas fa-edit"></i> Approve Team Leader</a>  
                              <?php
                              }
                              else {
                                echo "-";
                            ...
                            elseif($data->status == 2) {
                              ...
                              ?>
                              <a href="<?=site_url('ListCCM/ApproveSPV/').$data->id?>" class="btn btn-small btn-info" type="button"><i class="fas fa-edit"></i> Approve SPV</a>  
                              <?php
                              }
                              else {
                                echo "-";
                            ...
                            elseif($data->status == 3) {
                              ...
                              ?>
                              <a href="<?=site_url('ListCCM/ApproveManager/').$data->id?>" class="btn btn-small btn-info" type="button"><i class="fas fa-edit"></i> Approve Manager</a>  
                              <?php
                              }
                              else {
                                echo "-";
                            ...
                            //   print_r($data);
                              ...
                              ?>
                              <a href="<?=site_url('ListCCM/Verifikasi/').$data->id?>" class="btn btn-small btn-info" type="button"><i class="fas fa-edit"></i> Verifikasi</a>  
                              <?php
                                }
                              }
                              else {
