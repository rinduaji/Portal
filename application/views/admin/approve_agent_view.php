        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-4 pt-4 pb-4" >
                ...
                ?>
                <form method="post" action="<?=site_url('ListCCM/updateApproveAgent')?>" enctype="multipart/form-data">
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="login_agent" name="login_agent" value="<?=$data_approve_agent->username?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="nama_agent" name="nama_agent" value="<?=$data_approve_agent->name?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?=$data_approve_agent->jabatan?>" readonly>
                            </div>
                        </div>
                        <?php
                          if($hasil_jabatan == "TL") {
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="status_ccm" name="status_ccm" value="<?=$data_approve_agent->kode.' '.$data_approve_agent->level?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" class="form-control" id="tgl_awal" name="tgl_awal" value="<?=date("l, d F Y",strtotime($data_approve_agent->tgl_mulai))?>" readonly>
                            </div>
                            <div class="col-md-1 mb-3">
                                <label for="tgl_awal"> Sampai </label>
                            </div>
                            <div class="col-md-5 mb-3">
                                <input type="text" class="form-control" id="tgl_akhir" name="tgl_akhir" value="<?=date("l, d F Y",strtotime($data_approve_agent->tgl_akhir))?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="pelanggaran" name="pelanggaran" rows="5" readonly><?=$data_approve_agent->pelanggaran?></textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="alasan" name="alasan" rows="5" readonly><?=$data_approve_agent->alasan?></textarea>
                            </div>
                        </div>
                        <?php
                          if($hasil_jabatan == 'TL' OR $hasil_jabatan == 'SUPERVISOR' OR $hasil_jabatan == 'MANAGER') {
                        ?>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="komitmen" name="komitmen" rows="5"></textarea>
                            </div>
                        </div>
                        <?php
                          }
                          if($hasil_jabatan == 'SUPERVISOR' OR $hasil_jabatan == 'MANAGER') {
                        ?>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
