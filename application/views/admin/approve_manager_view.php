        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-4 pt-4 pb-4" >
                ...
                ?>
                <form method="post" action="<?=site_url('ListCCM/updateApproveManager')?>" enctype="multipart/form-data">
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="hidden" class="form-control" id="lup_mgr" name="lup_mgr" value="<?=date("Y-m-d h:i:s")?>" readonly>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                                <label for="login_agent">Login</label>
                            </div>
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="login_agent" name="login_agent" value="<?=$data_approve_manager->username?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="nama_agent" name="nama_agent" value="<?=$data_approve_manager->name?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?=$data_approve_manager->jabatan?>" readonly>
                            </div>
                        </div>
                        <?php
                          if($hasil_jabatan == "TL") {
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="status_ccm" name="status_ccm" value="<?=$data_approve_manager->kode.' '.$data_approve_manager->level?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" class="form-control" id="tgl_awal" name="tgl_awal" value="<?=date("l, d F Y",strtotime($data_approve_manager->tgl_mulai))?>" readonly>
                            </div>
                            <div class="col-md-1 mb-3">
                                <label for="tgl_awal"> Sampai </label>
                            </div>
                            <div class="col-md-5 mb-3">
                                <input type="text" class="form-control" id="tgl_akhir" name="tgl_akhir" value="<?=date("l, d F Y",strtotime($data_approve_manager->tgl_akhir))?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="pelanggaran" name="pelanggaran" rows="5" readonly><?=$data_approve_manager->pelanggaran?></textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="alasan" name="alasan" rows="5" readonly><?=$data_approve_manager->alasan?></textarea>
                            </div>
                        </div>
                        <?php
                          if($hasil_jabatan == 'TL') {
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="komitmen" name="komitmen" rows="5" readonly><?=$data_approve_manager->komitmen?></textarea>
                            </div>
                        </div>
                        <?php
                          }
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="penyuluhan" name="penyuluhan" rows="5" readonly><?=$data_approve_manager->penyuluhan?></textarea>
                            </div>
                        </div>
                        <?php
                          }
