...
<html lang="en">
    ...
    <body>
        ...
        <div style="text-align:center">
            <h3> <u>BERITA ACARA KONSELING</u> </h3>
        </div>
        <?php
        // foreach($data_ccm as $dc) {
        ?>
        <div style="border: 1px solid black;padding: 10px 10px">
            <table>
                <tbody>
                    ...
                    <tr>
                        <td scope="row">KONSELOR</td>
                        <td>:</td>
                        <td><?=$data_ccm->nama_tl?></td>
                    </tr>
                    <tr>
                        <td scope="row">TANGGAL KONSELING</td>
                        <td>:</td>
                        <td><?=date("d F Y",strtotime($data_ccm->tgl_mulai))?> - <?=date("d F Y",strtotime($data_ccm->tgl_akhir))?></td>
                    </tr>
                    <tr>
                        <td scope="row">TANGGAL VERIFIKASI</td>
                        <td>:</td>
                        <td><?=($data_ccm->tgl_verifi != "") ? date("d F Y",strtotime($data_ccm->tgl_verifi)) : ''?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div style="border: 1px solid black;padding: 10px 10px">
            <table>
                <tbody>
                    <tr>
                        <td scope="row">PERMASALAHAN YANG DIBAHAS</td>
                        <td>:</td>
        ...
        <div style="border: 1px solid black;padding: 10px 10px">
            <table>
                <tbody>
                    <tr>
                        <td scope="row">TINDAK LANJUT/KOMITMEN</td>
                        <td>:</td>
                        <td><?=$data_ccm->komitmen?></td>
                    </tr>
                    <tr>
                        <td scope="row">HASIL VERIFIKASI</td>
                        <td>:</td>
        ...
        <table style="text-align:left">
                <tbody>
                    ...
                    <tr>
                        <td width="175px" style="text-align:left">Atasan Konselor</td>
                        <td width="75px"></td>
                        <td width="175px" style="text-align:center">Pegawai yang dikonseling</td>
                        <td width="75px"></td>
                        <td width="175px" style="text-align:center">Konselor</td>
                    </tr>
                    <tr>
        ...
        <div style="position: absolute; bottom: 0px;">
            <h6>IN.HSC.TELK.F-03.Rev.00 / 19-06-2019</h6>
        </div>
    </body>
</html>