            ...
            <div class="card-body px-4 pt-4 pb-4" >
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="hidden" class="form-control" id="lup_agent" name="lup_agent" value="<?=date("Y-m-d h:i:s")?>" readonly>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                                <label for="login_agent">Login</label>
                            </div>
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="login_agent" name="login_agent" value="<?=$data_detail_ccm->username?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="nama_agent" name="nama_agent" value="<?=$data_detail_ccm->name?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?=$data_detail_ccm->jabatan?>" readonly>
                            </div>
                        </div>
                        <?php
                          if($hasil_jabatan == "TL") {
                            // var_dump($data_nama_groupmail);
                        ?>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-10 mb-3">
                                <input type="text" class="form-control" id="status_ccm" name="status_ccm" value="<?=$data_detail_ccm->kode.' '.$data_detail_ccm->level?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" class="form-control" id="tgl_awal" name="tgl_awal" value="<?=date("l, d F Y",strtotime($data_detail_ccm->tgl_mulai))?>" readonly>
                            </div>
                            <div class="col-md-1 mb-3">
                                <label for="tgl_awal"> Sampai </label>
                            </div>
                            <div class="col-md-5 mb-3">
                                <input type="text" class="form-control" id="tgl_akhir" name="tgl_akhir" value="<?=date("l, d F Y",strtotime($data_detail_ccm->tgl_akhir))?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="pelanggaran" name="pelanggaran" rows="5" readonly><?=$data_detail_ccm->pelanggaran?></textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="alasan" name="alasan" rows="5" readonly><?=$data_detail_ccm->alasan?></textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="komitmen" name="komitmen" rows="5" readonly><?=$data_detail_ccm->komitmen?></textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="penyuluhan" name="penyuluhan" rows="5" readonly><?=$data_detail_ccm->penyuluhan?></textarea>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2 mb-3">
                            ...
                            <div class="col-md-10 mb-3">
                                <textarea class="form-control" id="verifikasi" name="verifikasi" rows="5" readonly><?=$data_detail_ccm->verifikasi?></textarea>
                            </div>
                        </div>
                    </div>
                    
                    <a href="http://10.194.41.9:8080/portal/index.php/<?=$this->uri->segment(1)?>/" class="btn btn-primary" type="button">Go Back</a>
                    <!-- <button class="btn btn-primary" type="button" onclick="window.history.go(-1); return false;">Go Back</button> -->
                </form>
            </div>
          </div>
        </div>
